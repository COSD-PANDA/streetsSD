var opsControl = (function() {
  ...
  getTDistance = function(subLayerID, displayOp) {
    var sqlString = sqlBuilder.getDistanceSQL(
      subLayerID,
      tDistanceStringConfig,
    );
    //console.log("HI")
  ...
  return {
    ...
    workByMonth: function(subLayerID) {
      var sqlString = sqlBuilder.getDistanceSQL(subLayerID, {
        tableAlias: 'ic',
        groupFieldSQL:
          'to_char(' + sqlBuilder.mapAlias('ic', 'work_end') + ", 'MM'), type",
        lengthFieldAlias: 'adj_length',
        order: 'ASC',
      });
    ...
    bigNumbers: function(subLayerID, data) {
      var sqlString = sqlBuilder.getDistanceSQL(subLayerID, {
        tableAlias: 'ic',
        groupFieldSQL:
          'to_char(' + sqlBuilder.mapAlias('ic', 'work_end') + ", 'MM-YY')",
        lengthFieldAlias: 'adj_length',
        order: 'ASC',
      });
